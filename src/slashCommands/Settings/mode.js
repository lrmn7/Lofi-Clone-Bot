...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const thing = new MessageEmbed()
      ...
      .setAuthor({ name: `${client.user.username} - Modes`, iconURL: client.user.displayAvatarURL(), url: 'https://discord.gg/WFfjrQxnfH' })
    ...
    collector.on('collect', async i => {
      ...
      if (i.customId === 'info') {
        const slp = new MessageEmbed()
          .setAuthor({ name: `${client.user.username} - Help`, iconURL: client.user.displayAvatarURL(), url: 'https://discord.gg/WFfjrQxnfH' })
          .setColor(client.embedColor)
