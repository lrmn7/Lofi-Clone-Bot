...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const thing = new MessageEmbed()
      ...
      .setDescription(`
                Sleep Timer lets you fall asleep to Lucy tunes. At the end of the countdown Lucy Radio will disconnect you from the voice channel, allowing you to sleep well and stops your battery from draining.
