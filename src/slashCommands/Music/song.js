...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (!player.queue.current) {
      const thing = new MessageEmbed().setColor('RED').setDescription('There is no music playing.')
...
<:blank:1120331253569302619><:next:1119915811415539722> **${song.title}**`)
      ...
      .addFields([
        ...
        {
          name: 'Developer',
          value: '<:profile:1119915826326278265> **[Instagram](https://instagram.com/romanroman.nya)**',
          inline: true
        }
      ])
...
This title has been saved to your collection.`)
        ...
        const yt = new MessageButton()
          .setEmoji('1119915826326278265')
          .setURL('https://instagram.com/romanroman.nya')
          .setStyle('LINK').setDisabled(false)
