...
module.exports = {
  ...
  run: async (client, interaction, prefix) => {
    ...
    const userPfp = await resolveImage(interaction.user.displayAvatarURL({
      format: 'jpg',
      size: 1024
    }))

    const namee = interaction.user.username
    const image = new Canvas(754, 215)
    ...
    const imgg = new MessageAttachment(image, 'profile-lrmn.png')
