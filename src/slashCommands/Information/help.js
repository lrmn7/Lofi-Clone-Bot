...
module.exports = {
  name: 'help',
  description: `Show Lucy Radio's help menu.`,
  userPrams: [],
  ...
  run: async (client, interaction) => {
    ...
    const embed = new MessageEmbed()
        .setColor(`#DDBD86`)
          .setAuthor({ name: `${client.user.username}`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/WFfjrQxnfH` })
...
<:blank:1120331253569302619><:premium:1119915823964893214>  **/premium:** Shows information about Lucy Radio premium.
<:info:1119915789030535178> **Info:**
<:blank:1120331253569302619><:telegram:1119915847809515671> **/support:** Send us a message or [join](https://discord.gg/WFfjrQxnfH) our support server.
<:blank:1120331253569302619><:like:1119915795565269112> **/vote:** Vote for Lucy Radio.
<:blank:1120331253569302619><:invite:1119915791521955970> **/invite:** [Invite](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot%20applications.commands) Lucy Radio to your server.
`)
