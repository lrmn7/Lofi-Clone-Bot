...
module.exports = {
  name: 'support',
  description: 'Send invitation to join lucy radio support server',
  userPrams: [],
  ...
  run: async (client, interaction) => {
    ...
    const embed = new MessageEmbed()
      .setAuthor({ name: `${client.user.username}'s' support server`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/WFfjrQxnfH` })
